<x-layout>
	...
	<a href="/" class="inline-block text-block ml-4 mb-4">
			...
			<div class="flex flex-col items-center justify-center text-center">
				...
				<div>
					...
					<div class="text-lg space-y-6">
						...
						<a href="{{ $listing->website }}" target="_blank" class="block bg-laravel text-white mt-6 py-2 rounded-xl hover:opacity-80">
